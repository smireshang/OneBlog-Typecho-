<div class="footer">
    <div class="navigation">
        ...
        <p class="copyright">
            ...
            Powered by Typecho&nbsp;&nbsp;|&nbsp;&nbsp;Designed by<a href="https://luziyang.cn/" title="主题作者" target="_blank">luziyang.cn</a>
            <?php if (isset($this->options->ICP)): ?>
                <br/><a href="https://beian.miit.gov.cn/" target="_blank">工信部备案号:<?php $this->options->ICP();?><a id="laws">法律声明</a>
            <?php endif; ?>
        </p>
        <div class="contact">
...
<script src="<?php $this->options->themeUrl('/assets/sdk/jquery.min.js'); ?>"></script><!--基础依赖放在最前面--><!--基础依赖放在最前面-->
